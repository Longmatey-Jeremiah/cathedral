...
export function Topbar({ name, email, role, onMenuClick }: Props) {
  return (
    <header
      className={cn(
        'sticky top-0 z-20 flex h-16 items-center justify-between gap-3 border-b border-black/[0.05] bg-page-canvas/85 px-6 backdrop-blur',
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className={cn(
            'grid h-9 w-9 shrink-0 place-items-center rounded-full border border-black/[0.06] bg-fog/90 text-carbon lg:hidden',
